...
public class ModelUser implements IModelUser {
    ...
    @Override
    public void downloadCollect(Context context, String username, int pageId, OnCompleteListener<CollectBean[]> listener) {
    ...
    @Override
    public void deleteCollects(Context context, String username, int goodsId, OnCompleteListener<MessageBean> listener) {
        OkHttpUtils<MessageBean> utils = new OkHttpUtils<>(context);
